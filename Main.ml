...
(*Testing reference declaration*)
let%test _ = ( getValeur (main "../../exemples/exemple-14.mml") = (ReferenceValue "ref@1" ))
(*Testing reference reading*)
let%test _ = ( getValeur (main "../../exemples/exemple-15.mml") = (IntegerValue 1) )
(*Testing reference writing*)
let%test _ = ( getValeur (main "../../exemples/exemple-16.mml") = (IntegerValue 6 ) )
(*Testing while loop  (same as exemple13*)
let%test _ = ( getValeur (main "../../exemples/exemple-17.mml") = (IntegerValue 11) )
...
(* testing function definition type*)
let%test _ = ( getType (main "../../exemples/exemple-09.mml") = (FunctionType (VariableType (ref UnknownType, 1),VariableType(ref UnknownType, 1))) )
let%test _ = ( getType (main "../../exemples/exemple-11.mml") = IntegerType )
let%test _ = ( getType (main "../../exemples/exemple-12.mml") = IntegerType )
(*Testing while loop type *)
let%test _ = ( getType (main "../../exemples/exemple-13.mml") = UnitType )
(*Testing reference declaration type*)
let%test _ = ( getType (main "../../exemples/exemple-14.mml") = (ReferenceType IntegerType) )
(*Testing reference reading*)
...
let%test _ = ( getType (main "../../exemples/exemple-18.mml") = BooleanType )
(*Testing reference writing type*)
let%test _ = ( getType (main "../../exemples/exemple-19.mml") = UnitType )
